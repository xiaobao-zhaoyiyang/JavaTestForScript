...
public class JavaBean {
	 ...
	 * 生成Header
	 */
	// 用户的Token值，用户判定用户登录状态
	public static String TOKEN = "18f1ad957efd9e0b";
	// 用户uid值
	public static String UID = "7183104";
...
//					+ "token=18f1ad957efd9e0b, "
					+ "lang=zh, "
					+ "PHPSESSID=inejn5iuengq7muiqos0eeuaef, "
					+ "_ga=GA1.2.1056662492.1606553476,"
					+ " _gid=GA1.2.304345705.1606553476, "
					+ "MONITOR_WEB_ID=49b75dbd-30e5-49b8-b40f-1fc031cb4a7a, "
					+ "_gat=1");
